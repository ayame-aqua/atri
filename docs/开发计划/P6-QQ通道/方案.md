...
- P2-B 已关门。群学习继续只进 pending；P2-C 的日记 / 核心印象不要自动从群灌进桌宠

---

## 11. 借鉴

- Artemis 把 QQ 当主入口，我们**不学这个顺序**。P5 没验收不许写登录。
- 学它的「记忆按来源标」：群 episodes 带 `source_chat_id`；profile 仍是一份。不要后宫热切换。
- 不要把桌宠主动、看屏、SMTC 同步到群（FaustBot / Sakura 那套只留本机）。
